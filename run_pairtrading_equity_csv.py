...
from pair_trading.run_csv import PairTradingCsvRun
...
def run(csv_filename):
    ...
    csv_run = PairTradingCsvRun(config.get_positionsize(cfg), csv_filename_sorted)
    return csv_run
...
if __name__ == '__main__':
    ...
    parser.add_argument("-c", "--csv_filename", default='data/combined_oilgas_minute_window60_ALL_2020-06-01_to_2020-08-31.csv', help="csv file source.")
