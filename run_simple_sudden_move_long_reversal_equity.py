...
from strategy.bar_with_times_strategy.simple_sudden_move.long_trend_reversal.equity.run import SimpleSuddenMoveLongTrendReversalTradeEquityStrategyRun
...
def run(dryrun, forcerun, broker_str):
    ...
    trade_run = SimpleSuddenMoveLongTrendReversalTradeEquityStrategyRun(
        dryrun,
