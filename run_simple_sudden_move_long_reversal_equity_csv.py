...
from strategy.bar_with_times_strategy.simple_sudden_move.long_trend_reversal.equity.run_rawdata_csv import SimpleSuddenMoveLongTrendReversalTradeEquityStrategyCsvRun
...
def run(csv_filename):
    ...
    csv_run = SimpleSuddenMoveLongTrendReversalTradeEquityStrategyCsvRun(config.get_positionsize(cfg), csv_filename_sorted)
    return csv_run
...
if __name__ == '__main__':
    ...
    parser.add_argument("-c", "--csv_filename", default='data/stock_minute_LPTH_2020-08-03 06:30:00_to_2020-08-03 13:00:00.csv', help="csv file source.")
