...
from strategy.orderbook_strategy.orderbook_flow.run_csv import OrderbookFlowStrategyCsvRun
...
def run(csv_filename):
    ...
    csv_run = OrderbookFlowStrategyCsvRun(config.get_positionsize(cfg), csv_filename_sorted)
    return csv_run
...
if __name__ == '__main__':
    ...
    parser.add_argument("-c", "--csv_filename", default='data/2020-06-30/orderbook_bucket_2020-06-30.csv', help="csv file source.")
