...
class SuddenMoveTrendReversalTradeStrategyRun(BarWithTimeTradeStrategyRun):
    def __init__(self, dry_run, positionsize, a_current_time = None, subscription_id = None):
        ...
        symbol_to_strategy = lambda symbol: SuddenMoveTrendReversalCryptoTradeStrategy(self.positionsize, symbol, self.long_enter, self.long_exit, self.short_enter, self.short_exit)
        super().__init__(
            positionsize,
