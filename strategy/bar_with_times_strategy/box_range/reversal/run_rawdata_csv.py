from strategy.bar_with_times_strategy.box_range.reversal.strategy import BoxRangeTrendFollowingTradeStrategy
import util.logging
...
class BoxRangeExitFollowingTradeStrategyCsvRun(BarWithTimeTradeTradeStrategyCsvRun):
    def __init__(self, positionsize, csv_filename):
        ...
        symbol_to_strategy = lambda symbol: BoxRangeTrendFollowingTradeStrategy(self.positionsize, symbol, self.long_enter, self.long_exit, self.short_enter, self.short_exit, current_time=mock_current_time)
