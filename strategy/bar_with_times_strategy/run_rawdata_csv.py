...
from strategy.ingestion_run.bar_with_times_ingestion_run.csv_rawdata_ingestion_run import BarWithTimesCsvIngestionRun
...
class BarWithTimeTradeTradeStrategyCsvRun(BarWithTimeTradeStrategyRun):
    ...
    def on_trade(self, trade):
        ...
        self.strategy_per_symbol[trade.symbol].current_time.set_current_epoch_seconds(ts)
