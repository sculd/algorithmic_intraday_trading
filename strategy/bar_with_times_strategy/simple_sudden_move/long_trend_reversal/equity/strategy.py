from strategy.bar_with_times_strategy.simple_sudden_move.long_trend_reversal.strategy import SimpleSuddenMoveLongTrendReversalTradeStrategy
...
class SimpleSuddenMoveLongTrendReversalTradeEquityStrategy(SimpleSuddenMoveLongTrendReversalTradeStrategy):
