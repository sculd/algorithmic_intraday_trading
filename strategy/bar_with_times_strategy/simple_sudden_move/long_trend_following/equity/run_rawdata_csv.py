...
class SimpleSuddenMoveLongTrendFollowingTradeEquityStrategyCsvRun(BarWithTimeTradeTradeStrategyCsvRun):
    def __init__(self, positionsize, csv_filename):
        ...
        symbol_to_strategy = lambda symbol: SimpleSuddenMoveLongTrendFollowingTradeEquityStrategy(self.positionsize, symbol, self.long_enter, self.long_exit, self.short_enter, self.short_exit, current_time=mock_current_time)
