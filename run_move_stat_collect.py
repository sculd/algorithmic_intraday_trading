...
from strategy.bar_with_times_strategy.move_stat_collect.run_csv import MoveStatCollectStrategyCsvRun
...
def run(csv_filename):
    ...
    csv_run = MoveStatCollectStrategyCsvRun(config.get_positionsize(cfg), csv_filename_sorted)
    return csv_run
...
if __name__ == '__main__':
    ...
    parser.add_argument("-c", "--csv_filename", default='data/stock_minute_PSTV_2020-08-07 06:30:00_to_2020-08-07 13:00:00.csv', help="csv file source.")
