...
from strategy.bar_with_times_strategy.timeseries_analysis.trend_reserval.crypto.run_csv import SuddenMoveTrendReversalTradeStrategyCsvRun
...
if __name__ == '__main__':
    ...
    parser.add_argument("-c", "--csv_filename", default='data/binance_minute_window60_ALL_2020-09-27 17:00:00_to_2020-09-28 16:00:00.csv', help="csv file source.")
