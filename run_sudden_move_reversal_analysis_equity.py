...
from strategy.bar_with_times_strategy.timeseries_analysis.trend_reserval.equity.run import SuddenMoveTrendReversalTradeStrategyRun
...
def run(dryrun, forcerun, broker_str):
    ...
    trade_run = SuddenMoveTrendReversalTradeStrategyRun(
        dryrun,
